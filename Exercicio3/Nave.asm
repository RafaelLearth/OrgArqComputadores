...
loop: 	
		loadn r0, #4
		mod r0, r7, r0	; Armazena em r0 o resto da divisão entre a posição na tela e 10
		cmp r0, r1
		ceq Atualisa_Nave	; Coloca a nave na linha abaixo quando chega ao fim da tela (na direita)
